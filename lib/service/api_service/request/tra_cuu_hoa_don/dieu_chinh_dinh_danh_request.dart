...
//
//     final dieuChinhDinhDanhRequest = dieuChinhDinhDanhRequestFromJson(jsonString);

import 'dart:convert';

DieuChinhDinhDanhRequest dieuChinhDinhDanhRequestFromJson(String str) => DieuChinhDinhDanhRequest.fromJson(json.decode(str));

String dieuChinhDinhDanhRequestToJson(DieuChinhDinhDanhRequest data) => json.encode(data.toJson());

class DieuChinhDinhDanhRequest {
  DieuChinhDinhDanhRequest({
    this.loaihdon,
    this.tinhchat,
    this.sohdon,
    this.mstnmua,
  ...
  factory DieuChinhDinhDanhRequest.fromJson(Map<String, dynamic> json) => DieuChinhDinhDanhRequest(
