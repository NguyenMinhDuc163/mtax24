...
class _HoaDonChiTietScreenState extends State<HoaDonChiTietScreen> with GetItStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    registerHandler((LapHoaDonModel x) => x.checkAmountHoaDon, (context, BaseResponse response, cancel) {
      if(response != null){
        isCheck = true;
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Expanded(child: Text("${listHangHoa[index].soluong.isEmpty ? "0" : listHangHoa[index].soluong}", style: text14Bold600, textAlign: TextAlign.center), flex: 1,),
