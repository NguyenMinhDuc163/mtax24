...
//
//     final traCuuHddcResponse = traCuuHddcResponseFromJson(jsonString);

import 'dart:convert';

List<TraCuuHddcResponse> traCuuHddcResponseFromJson(String str) => List<TraCuuHddcResponse>.from(json.decode(str).map((x) => TraCuuHddcResponse.fromJson(x)));

String traCuuHddcResponseToJson(List<TraCuuHddcResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class TraCuuHddcResponse {
  TraCuuHddcResponse({
    this.channelCode,
    this.typehdongoc,
    this.serviceType,
  ...
  factory TraCuuHddcResponse.fromJson(Map<String, dynamic> json) => TraCuuHddcResponse(
