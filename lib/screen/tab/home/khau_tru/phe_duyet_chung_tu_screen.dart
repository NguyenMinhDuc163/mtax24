...
import 'package:mtax24/screen/tab/home/khau_tru/filter_phe_duyet_chung_tu_screen.dart';
...
class PheDuyetChungTuScreen extends StatefulWidget with GetItStatefulWidgetMixin{

  @override
  State<StatefulWidget> createState() => _ScreenState();
}

class _ScreenState extends State<PheDuyetChungTuScreen> with GetItStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: Stack(
          children: [
            CustomerListViewAppbarScreen(title: "Phê duyệt chứng từ", isShowBack: true, isShowHome: true,
              children: ListView(
                                  ...
                                  child: IconButton(
                                      onPressed: () async {
                                        final result = await Navigator.push(
                                            context, new MaterialPageRoute(builder: (context) => FilterPheDuyetChungTuScreen(object: filterObjectTc, tuNgay: tuNgay, denNgay: denNgay,)));
                                        if(result != null){
                                          setState(() {
