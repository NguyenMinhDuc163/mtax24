...
//
//     final traCuuHdttResponse = traCuuHdttResponseFromJson(jsonString);

import 'dart:convert';

List<TraCuuHdttResponse> traCuuHdttResponseFromJson(String str) => List<TraCuuHdttResponse>.from(json.decode(str).map((x) => TraCuuHdttResponse.fromJson(x)));

String traCuuHdttResponseToJson(List<TraCuuHdttResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class TraCuuHdttResponse {
  TraCuuHdttResponse({
    this.channelCode,
    this.typehdongoc,
    this.serviceType,
  ...
  factory TraCuuHdttResponse.fromJson(Map<String, dynamic> json) => TraCuuHdttResponse(
